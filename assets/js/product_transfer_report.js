$(document).ready(function(){
	var dtproduct_transfer_report = $('#dtproduct_transfer_report').DataTable({
      // "paging": true,
      // "lengthChange": true,
      "processing": true,
      "serverSide": true,
      ...
      "order": [],
        ...
        "ajax": {
            "url": "HomeController/dtproduct_transfer_report/",
            "type": "POST"
        },
  });
    ...
    preConfirm: function() {
       return new Promise(function(resolve) {                
          ...
          .done(function(response){
              ...
              $('#dtproduct_transfer_report').DataTable().ajax.reload();
          })
          .fail(function(){
