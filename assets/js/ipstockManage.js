$(document).ready(function(){
	var dtIpstockmanage = $('#dtIpstockmanage').DataTable({
      // "paging": true,
      // "lengthChange": true,
      "processing": true,
      "serverSide": true,
      ...
      "order": [],
        ...
        "ajax": {
            "url": "HomeController/dtIpstockmanage/",
            "type": "POST"
        },
  });

  //To Select the id of member to delete
  $(document).on('click', '#delete_ipstock', function(e){ 
    ...
    preConfirm: function() {
       return new Promise(function(resolve) {                
          ...
          .done(function(response){
              ...
              $('#dtIpstockmanage').DataTable().ajax.reload();
          })
          .fail(function(){
