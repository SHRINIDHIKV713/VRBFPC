$(document).ready(function(){
	var dtcharges_collection_report = $('#dtcharges_collection_report').DataTable({
      // "paging": true,
      // "lengthChange": true,
      "processing": true,
      "serverSide": true,
      ...
      "order": [],
        ...
        "ajax": {
            "url": "HomeController/dtcharges_collection_report/",
            "type": "POST"
        },
  });
    ...
    preConfirm: function() {
       return new Promise(function(resolve) {                
          ...
          .done(function(response){
              ...
              $('#dtcharges_collection_report').DataTable().ajax.reload();
          })
          .fail(function(){
