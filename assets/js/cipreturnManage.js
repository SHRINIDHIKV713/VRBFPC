$(document).ready(function(){
	var dtCipreturnmanage = $('#dtCipreturnmanage').DataTable({
      // "paging": true,
      // "lengthChange": true,
      "processing": true,
      "serverSide": true,
      ...
      "order": [],
        ...
        "ajax": {
            "url": "CeoController/dtCipreturnmanage/",
            "type": "POST"
        },
  });

  //To Select the id of member to delete
  $(document).on('click', '#delete_ipreturn', function(e){ 
    ...
    preConfirm: function() {
       return new Promise(function(resolve) {                
          ...
          .done(function(response){
              ...
              $('#dtCipreturnmanage').DataTable().ajax.reload();
          })
          .fail(function(){
