$(document).ready(function(){
	var dtCbdmanage = $('#dtCbdmanage').DataTable({
    "paging": true,
    "lengthChange": true,
    "searching": true,
    "ordering": true,
    ...
    "responsive": true,
      ...
      "order": [],
        ...
        "ajax": {
            "url": "CeoController/dtCbdmanage/",
            "type": "POST"
        },
  });

  //To Select the id of member to delete
  $(document).on('click', '#delete_bd', function(e){ 
    ...
    preConfirm: function() {
       return new Promise(function(resolve) {                
          ...
          .done(function(response){
              ...
              $('#dtCbdmanage').DataTable().ajax.reload();
          })
          .fail(function(){
