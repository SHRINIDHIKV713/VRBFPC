$(document).ready(function(){
	var dtcrop_harvest_report = $('#dtcrop_harvest_report').DataTable({
      // "paging": true,
      // "lengthChange": true,
      "processing": true,
      "serverSide": true,
      ...
      "columnDefs": [{ targets: [0], className: 'dt-center valign dt-w3' },
                    ...
                    {targets: [8], className: 'dt-center dt-w15 valign'}],
      dom: 'Bfrtip',
      buttons: [
      ...
      "order": [],
        ...
        "ajax": {
            "url": "HomeController/dtcrop_harvest_report/",
            "type": "POST"
        },
  });
    ...
    preConfirm: function() {
       return new Promise(function(resolve) {                
          ...
          .done(function(response){
              ...
              $('#dtcrop_harvest_report').DataTable().ajax.reload();
          })
          .fail(function(){
