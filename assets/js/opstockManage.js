$(document).ready(function(){
	var dtOpstockmanage = $('#dtOpstockmanage').DataTable({
      // "paging": true,
      // "lengthChange": true,
      "processing": true,
      "serverSide": true,
      ...
      "columnDefs": [{ targets: [0], className: 'dt-center valign dt-w3' },
                    { targets: [1,2,3,4,5,6,7], className: 'dt-left valign dt-w52' },
      ...
      "order": [],
        ...
        "ajax": {
            "url": "HomeController/dtOpstockmanage/",
            "type": "POST"
        },
  });

  //To Select the id of member to delete
  $(document).on('click', '#delete_opstock', function(e){ 
    ...
    preConfirm: function() {
       return new Promise(function(resolve) {                
          ...
          .done(function(response){
              ...
              $('#dtOpstockmanage').DataTable().ajax.reload();
          })
          .fail(function(){
