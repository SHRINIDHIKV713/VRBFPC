$(document).ready(function(){
	var dtCipcatalogmanage = $('#dtCipcatalogmanage').DataTable({
    "paging": true,
    "lengthChange": true,
    "searching": true,
    "ordering": true,
    ...
    "responsive": true,
      ...
      "order": [],
        ...
        "ajax": {
            "url": "CeoController/dtCipcatalogmanage/",
            "type": "POST"
        },
  });

  //To Select the id of member to delete
  $(document).on('click', '#delete_ipcatalog', function(e){ 
    ...
    preConfirm: function() {
       return new Promise(function(resolve) {                
          ...
          .done(function(response){
              ...
              $('#dtCipcatalogmanage').DataTable().ajax.reload();
          })
          .fail(function(){
