$(document).ready(function(){
	var dtCipindentmanage = $('#dtCipindentmanage').DataTable({
      // "paging": true,
      // "lengthChange": true,
      "processing": true,
      "serverSide": true,
      ...
      "columnDefs": [{ targets: [0], className: 'dt-center valign dt-w3' },
                    { targets: [1,2,3,5,6,7,8], className: 'dt-left valign dt-w52' },
      ...
      "order": [],
        ...
        "ajax": {
            "url": "CeoController/dtCipindentmanage/",
            "type": "POST"
        },
  });

  //To Select the id of member to delete
  $(document).on('click', '#delete_ipindent', function(e){ 
    ...
    preConfirm: function() {
       return new Promise(function(resolve) {                
          ...
          .done(function(response){
              ...
              $('#dtCipindentmanage').DataTable().ajax.reload();
          })
          .fail(function(){
