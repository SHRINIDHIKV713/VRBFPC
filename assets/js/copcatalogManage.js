$(document).ready(function(){
	var dtCopcatalogmanage = $('#dtCopcatalogmanage').DataTable({
      // "paging": true,
      // "lengthChange": true,
      "processing": true,
      "serverSide": true,
      ...
      "order": [],
        ...
        "ajax": {
            "url": "CeoController/dtCopcatalogmanage/",
            "type": "POST"
        },
  });

  //To Select the id of member to delete
  $(document).on('click', '#delete_opcatalog', function(e){ 
    ...
    preConfirm: function() {
       return new Promise(function(resolve) {                
          ...
          .done(function(response){
              ...
              $('#dtCopcatalogmanage').DataTable().ajax.reload();
          })
          .fail(function(){
