$(document).ready(function(){
	var dtCiptransfermanage = $('#dtCiptransfermanage').DataTable({
      // "paging": true,
      // "lengthChange": true,
      "processing": true,
      "serverSide": true,
      ...
      "order": [],
        ...
        "ajax": {
            "url": "CeoController/dtCiptransfermanage/",
            "type": "POST"
        },
  });

  //To Select the id of member to delete
  $(document).on('click', '#delete_iptransfer', function(e){ 
    ...
    preConfirm: function() {
       return new Promise(function(resolve) {                
          ...
          .done(function(response){
              ...
              $('#dtCiptransfermanage').DataTable().ajax.reload();
          })
          .fail(function(){
