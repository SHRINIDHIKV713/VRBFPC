$(document).ready(function(){
	var dtCopreturnmanage = $('#dtCopreturnmanage').DataTable({
      // "paging": true,
      // "lengthChange": true,
      "processing": true,
      "serverSide": true,
      ...
      "order": [],
        ...
        "ajax": {
            "url": "CeoController/dtCopreturnmanage/",
            "type": "POST"
        },
  });

  //To Select the id of member to delete
  $(document).on('click', '#delete_opreturn', function(e){ 
    ...
    preConfirm: function() {
       return new Promise(function(resolve) {                
          ...
          .done(function(response){
              ...
              $('#dtCopreturnmanage').DataTable().ajax.reload();
          })
          .fail(function(){
