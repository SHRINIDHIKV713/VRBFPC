 ...
 * FPO Model
 */
class OpreturnModel extends CI_Model
{
    ...
    function addOpreturnentry(){
        ...
        $datat=array('date_of'=>$date_of,'store'=>$store,'supplier_name'=>$supplier_name,
        ...
        'status'=>'1');
            ...
            // Insert the data
            $result = $this->db->insert('opreturn',$datat);
    ...
    function editOpreturnentry(){
        ...
        $datat=array('date_of'=>$edit_date_of,'store'=>$edit_store,'supplier_name'=>$edit_supplier_name,
        ...
        'status'=>'1');
            ...
            // Insert the data
            $this->db->where('id',$oprid);
            $result = $this->db->update('opreturn',$datat);
    ...
    function delOPR(){
        ...
        $result=$this->db->update('opreturn',$data);
        if($result){
            $output['success'] = true;
