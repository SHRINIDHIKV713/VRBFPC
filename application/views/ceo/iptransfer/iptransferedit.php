<?php
    ...
    status')->from('iptransfer')->where('id',$id)->get();
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="hidden" name="iptid" id="iptid" value="<?php echo $id ?>">
 ...
 <option value="Godown" <?php echo ('Godown' == $row->from_store) ? 'selected="selected"' : '';?> >Godown</option>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select class="form-control select2 form-select" data-placeholder="Choose one" 
                        name="edit_to_store" value="<?php echo $row->to_store?>">
                        
 <option value="Store" <?php echo ('Store' == $row->to_store) ? 'selected="selected"' : '';?> >Store</option>
 <option value="Godown" <?php echo ('Godown' == $row->to_store) ? 'selected="selected"' : '';?> >Godown</option>
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        data-placeholder="Choose one" name="edit_product_name" id="edit_product_name"
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="edit_store" id="edit_store"
                        pattern="^[A-Za-z -]+$"  value="<?php echo $row->store?>">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
