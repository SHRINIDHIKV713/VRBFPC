...
<div class="card-header" style="background: #435e9c;color: #fff;">
    ...
    <div class="col-md-12">
        <div class="row">
            ...
            <div class="col-md-6">
            <div class="text-end">
            <a role="button" href="ippurchaseentry" class="btn btn-outline-secondary" >
    ...
    <div class="card-body">
        <div class="container table-responsive">
            <table id="dtCippurchasemanage" class="table table-striped table-bordered nowrap" style="width:100%;">
                <thead>
                    <tr>
                    ...
                    <th class="border-bottom-0">Store/Godown Name</th>
